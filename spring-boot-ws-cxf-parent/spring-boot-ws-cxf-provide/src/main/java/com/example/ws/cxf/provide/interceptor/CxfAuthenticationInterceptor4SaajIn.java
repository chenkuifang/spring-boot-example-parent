...
@Slf4j
@Component
public class CxfAuthenticationInterceptor4SaajIn extends AbstractPhaseInterceptor<SoapMessage> {

    private SAAJInInterceptor saajIn = new SAAJInInterceptor();

    public CxfAuthenticationInterceptor4SaajIn() {
    ...
    public void handleMessage(SoapMessage message) throws Fault {
        ...
        try {
            ...
            System.err.println("请求参数： " + requestParams);

            JSONObject jsonBody = XmlParseJsonUtils.xml2Json(requestParams);
            ...
            //InputStream ism = new ByteArrayInputStream(jsonBody.toString().getBytes());
