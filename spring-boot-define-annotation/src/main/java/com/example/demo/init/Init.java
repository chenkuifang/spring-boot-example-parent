...
/**
 * @Description: 自定义注解自动扫描初始化方法这里列出2种：
 *               <p>
 *               1.使用servlet 容器启动时启动的注解 @PostConstruct
 *               <p>
 *               2.使用应用的监听器ApplicationListener接口的onApplicationEvent方法。例子如AnnotationScan类
 * @author QuiFar
 * @date 2018年1月2日 下午8:44:07
 * @version V1.0
 */
@Component
public class Init {
	...
	private void filterAndInstance() throws Exception {
		...
		for (String className : packageNames) {
			...
			if (cName.isAnnotationPresent(Controller.class)) {
				...
				isContailsAnnotation(methods, "com.example.demo.annotation.Log");
			}
		}
	 ...
	 *            注解路径，如com.example.demo.annotation.Log
	 * @return
	 */
